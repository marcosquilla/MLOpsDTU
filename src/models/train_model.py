...
class TrainOREvaluate(object):
    ...
    def train(self):
        ...
        trainset = datasets.MNIST('~/MLOpsDTU/data', train=True)
        num_classes = 10
        channels = 1
        ...
        plt.plot(losses)
        plt.savefig('MLOpsDTU/reports/figures/training_curve.png')
        torch.save(model.state_dict(), 'MLOpsDTU/models/state')
